          ...
          >
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-2 text-[12px] text-white/45 font-[family-name:var(--font-sans)]">
                    One guest per line: <span className="text-white/70">Name, Phone, Category, Party size, Email</span>
                  </p>
                </div>
              ...
              <textarea
                ...
                rows={9}
                placeholder={"Amara Johnson, 08031234567, VIP, 1, amara@email.com\nEmeka Eze, 07069876543, Family, 1, emeka@email.com\nFatima Bello, 08155551234, Guest, 1\nChidi Okonkwo"}
