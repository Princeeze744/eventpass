        ...
        <div className="sb-sticky -mx-5 mb-8 px-5 py-3.5 sm:-mx-8 sm:px-8">
          <div className="mx-auto flex max-w-[1000px] items-center justify-between">
            <Link href="/" className="group flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#f5f1ea] p-1.5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.9),0_6px_18px_-6px_rgba(0,0,0,0.7)] transition-transform duration-500 group-hover:scale-105"><Image src="/brand/logo-white.jpg" alt="Story Box" width={30} height={30} className="rounded-xl" /></span>
